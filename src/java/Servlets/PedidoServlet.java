...
public class PedidoServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (opcion) {
            ...
            case "listarpedidos":
                response_server = pedcon.listarPedidos(usr.getIdUser());
                break;
                
            case "listarpedidoscancelados":
                response_server = pedcon.listarPedidosCancelados(usr.getIdUser());
                break;
                
            case "listarpedidosTienda":
                response_server = pedcon.listarPedidosTienda(usr.getIdUser());
                break;
            ...
            case "insertarPedido":
                ...
                String status = pedcon.insertarPedido(estado, usr.getIdUser(), total);
            ...
            case "cancelarPedido":
                ...
                pedelx.insertarPedidoEliminado(fecha_pedido, usr.getIdUser(), descuento, totalx);
            ...
            case "cantidadDescuento":
                response_server = pedcon.cantidadDescuento(usr.getIdUser());
                break;
